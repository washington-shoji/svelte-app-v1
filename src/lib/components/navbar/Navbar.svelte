<script lang="ts">
	function sidebarHandler(state: boolean) {
...
<div class="w-64 absolute sm:relative bg-gray-800 shadow flex-col justify-between hidden sm:flex">
	<div class="px-8">
		...
		<ul class="mt-12">
			...
			>
				<a href="/posts" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
					<svg
						xmlns="http://www.w3.org/2000/svg"
